...
dnss.append(["169.158.176.75", "Cuba DNS"]) # taxon.mnhnc.inf.cu
...
dnss.append(["217.174.227.242", "Turkmenistan DNS"])
dnss.append(["213.42.43.226", "United Arab Emirates DNS"])
dnss.append(["109.228.17.100", "United Kingdom DNS"]) # server109-228-17-100.live-servers.net.
